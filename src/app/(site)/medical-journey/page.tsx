...
export default function MedicalJourneyPage() {
  ...
  image="/journey.webp"
  compact
  contentClassName="w-full max-w-[1280px]"
...
>
      ...
      <section className="pt-8 pb-14 px-6 max-w-6xl mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-12 space-y-3">
          ...
          <h2 className="text-2xl md:text-3xl font-serif text-midnight">
      ...
      <section className="py-14 px-6 bg-white border-y border-slate-100">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl">
            <Image
              src="/during.webp"
              alt="Coordinating your healthcare journey with patient support"
              fill
          ...
          <div className="space-y-4">
            ...
            <h2 className="text-3xl font-serif text-midnight">
              Every Healthcare Journey Is Different
            </h2>
